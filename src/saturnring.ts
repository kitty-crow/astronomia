...
import planetposition, { type Planet } from './planetposition.ts'
 ...
 */
export function ring (jde: number, earth: Planet, saturn: Planet) : [number, number, number, number, number, number] { // (jde float64, earth, saturn *pp.V87Planet)  (B, Bʹ, ΔU, P, aEdge, bEdge float64)
 ...
 */
export function ub (jde: number, earth: Planet, saturn: Planet) { // (jde float64, earth, saturn *pp.V87Planet)  (ΔU, B float64)
 ...
 */
function cl (jde: number, earth: Planet, saturn: Planet): [() => [number, number], () => [number, number, number, number]] { // (jde float64, earth, saturn *pp.V87Planet)  (f1 func() (ΔU, B float64),
  ...
  let slʹΩ = 0
  let clʹΩ = 0
  const f1 = function () : [number, number] { // (ΔU, B float64)
    // (45.1), p. 318
  ...
  const f2 = function () : [number, number, number, number] { // (Bʹ, P, aEdge, bEdge) {
