...
export class Equatorial {
   ...
   */
  constructor (ra: number = 0, dec: number = 0) {
    this.ra = ra
    this.dec = dec
  }
   ...
   * @returns {Horizontal}
   */
  toHorizontal (g: GlobeCoord, st: number) {
...
export class Horizontal {
  ...
  constructor (az: number = 0, alt: number = 0) {
    this.az = az
    this.alt = alt
  }
   ...
   */
  toEquatorial (g: GlobeCoord, st: number) {
