 ...
 */
export function ephemeris (jd: number, earth: Planet) : [number, number, number] { // (jd float64, e *pp.V87Planet)  (P, B0, L0 float64)
 ...
 */
export function cycle (c: number) { // (c int)  (jde float64)
