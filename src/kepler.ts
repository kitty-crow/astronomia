 ...
 */
export function trueAnomaly (E: number, e: number) {
  // (30.1) p. 195
 ...
 */
export function radius (E: number, e: number, a: number) { // (E, e, a float64)  float64
  // (30.2) p. 195
 ...
 */
export function kepler1 (e: number, m: number, places: number) {
  const f = function (E0: number) {
 ...
 * @return {number} eccentric anomaly `E` in radians.
 */
export function kepler2 (e: number, m: number, places: number) { // (e, M float64, places int)  (E float64, err error)
  const f = function (E0: number) {
 ...
 * @return {number} eccentric anomaly `E` in radians.
 */
export function kepler2a (e: number, m: number, places: number) { // (e, M float64, places int)  (E float64, err error)
  const f = function (E0: number) {
    const [se, ce] = base.sincos(E0)
 ...
 * @return {number} eccentric anomaly `E` in radians.
 */
export function kepler2b (e: number, m: number, places: number) { // (e, M float64, places int)  (E float64, err error)
  const f = function (E0: number) {
    const [se, ce] = base.sincos(E0)
 ...
 * @return {number} eccentric anomaly `E` in radians.
 */
export function kepler3 (e: number, m: number) { // (e, m float64)  (E float64)
 ...
 * @return {number} eccentric anomaly `E` in radians.
 */
export function kepler4 (e: number, m: number) { // (e, m float64)  (E float64)
