 ...
 */
export function physical (jde: number, earth: Planet, jupiter: Planet) : [number, number, number, number, number] { // (jde float64, earth, jupiter *pp.V87Planet)  (DS, DE, ω1, ω2, P float64)
  // Step 1.0
 ...
 *                  as seen from Earth.
 */
export function physical2 (jde: number) : [number, number, number, number] { // (jde float64)  (DS, DE, ω1, ω2 float64)
