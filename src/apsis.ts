 ...
 */
const snap = function (y: number, h: number) {
 ...
 * @return {Number} jde - Julian ephemeris day
 */
export function meanApogee (year: number) { // (year float64)  float64
 ...
 */
export function distance (parallax: number) {
