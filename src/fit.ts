 ...
 */
export function linear (points: readonly Point[]) : [number, number] { // (p []struct{ X, Y float64 })  (a, b float64)
  let sx = 0
  let sy = 0
  let sx2 = 0
  let sxy = 0
 ...
 */
export function correlationCoefficient (points: readonly Point[]): number { // (p []struct{ X, Y float64 })  float64
  let sx = 0
  let sy = 0
  let sx2 = 0
  let sy2 = 0
 ...
 */
export function quadratic (points: readonly Point[]) : [number, number, number] {
  let P = 0
  let Q = 0
  let R = 0
  let S = 0
 ...
 */
export function func3 (points: readonly Point[], f0: BasisFunction, f1: BasisFunction, f2: BasisFunction) : [number, number, number] {
  let M = 0
  let P = 0
  let Q = 0
  let R = 0
 ...
 * a fitting y = aƒ(x).
 */
export function func1 (points: readonly Point[], f: BasisFunction): number {
  let syf = 0
  let sf2 = 0
  // (4.8) p. 45
  for (const p of points) {
