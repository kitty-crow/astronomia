 ...
 */
export function semidiameter (s0: number, Δ: number) { // (s0, Δ float64)  float64
  return s0 / Δ
}
 ...
 */
export function saturnApparentPolar (Δ: number, B: number) { // (Δ, B float64)  float64
 ...
 */
export function moonTopocentric (Δ: number, δ: number, H: number, ρsφʹ: number, ρcφʹ: number) { // (Δ, δ, H, ρsφʹ, ρcφʹ float64)  float64
  const k = 0.272481
 ...
 * Result is semidiameter in radians.
 */
export function moonTopocentric2 (Δ: number, h: number) { // (Δ, h float64)  float64
 ...
 * Result is in km.
 */
export function asteroidDiameter (H: number, A: number) { // (H, A float64)  float64
 ...
 * Result is semidiameter in radians.
 */
export function asteroid (d: number, Δ: number) { // (d, Δ float64)  float64
