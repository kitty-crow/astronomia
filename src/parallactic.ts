 ...
 */
export function parallacticAngle (φ: number, δ: number, H: number) { // (φ, δ, H float64)  float64
 ...
 */
export function parallacticAngleOnHorizon (φ: number, δ: number) { // (φ, δ float64)  float64
 ...
 */
export function eclipticAtHorizon (ε: number, φ: number, θ: number) : [number, number, number] { // (ε, φ, θ float64)  (λ1, λ2, I float64)
 ...
 */
export function eclipticAtEquator (λ: number, ε: number) { // (λ, ε float64)  float64
 ...
 * All angles in radians.
 */
export function diurnalPathAtHorizon (δ: number, φ: number) { // (δ, φ float64)  (J float64)
  const tφ = Math.tan(φ)
