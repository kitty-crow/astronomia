 ...
 *   {Number} z
 */
export function position (earth: Planet, jde: number) { // (e *pp.V87Planet, jde float64)  (x, y, z float64)
  // (26.1) p. 171
 ...
 */
export function longitudeJ2000 (earth: Planet, jde: number) {
 ...
 *   {Number} z
 */
export function positionJ2000 (earth: Planet, jde: number) {
...
export function xyz (earth: Planet, jde: number) {
 ...
 *   {Number} z
 */
export function positionB1950 (earth: Planet, jde: number) { // (e *pp.V87Planet, jde float64)  (x, y, z float64)
  const { x, y, z } = xyz(earth, jde)
  return {
 ...
 *   {Number} z
 */
export function positionEquinox (earth: Planet, jde: number, epoch: number) {
