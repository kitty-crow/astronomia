 ...
 */
export function mean (y: number, a: Ca): [number, number, number] { // (y float64, a *ca)  (J, M, T float64)
  // (36.1) p. 250
 ...
 */
export function sum (T: number, M: number, c: readonly (readonly number[])[]): number { // (T, M float64, c [][]float64)  float64
 ...
 */
export function ms (y: number, a: Ca, c: readonly (readonly number[])[]): number { // (y float64, a *ca, c [][]float64)  float64
 ...
 * decimal year.)
 */
export function mercuryInfConj (y: number) { // (y float64)  (jde float64)
 ...
 * decimal year.)
 */
export function mercurySupConj (y: number) { // (y float64)  (jde float64)
 ...
 * decimal year.)
 */
export function venusInfConj (y: number) { // (y float64)  (jde float64)
 ...
 * decimal year.)
 */
export function marsOpp (y: number) { // (y float64)  (jde float64)
  return ms(y, moA, moB)
}
 ...
 */
export function sumA (T: number, M: number, c: readonly (readonly number[])[], aa: readonly Caa[]): number { // (T, M float64, c [][]float64, aa []caa)  float64
  let i = c.length - 2 * aa.length
  let j = sum(T, M, c.slice(0, i))
  for (let k = 0; k < aa.length; k++) {
    const angle = base.at(aa, k)
    const [saa, caa] = base.sincos((angle.c + angle.f * T) * Math.PI / 180)
 ...
 */
export function msa (y: number, a: Ca, c: readonly (readonly number[])[], aa: readonly Caa[]): number { // (y float64, a *ca, c [][]float64, aa []caa)  float64
  const [J, M, T] = mean(y, a)
 ...
 * decimal year.)
 */
export function jupiterOpp (y: number) { // (y float64)  (jde float64)
 ...
 * decimal year.)
 */
export function saturnOpp (y: number) { // (y float64)  (jde float64)
 ...
 * decimal year.)
 */
export function saturnConj (y: number) { // (y float64)  (jde float64)
 ...
 * decimal year.)
 */
export function uranusOpp (y: number) { // (y float64)  (jde float64)
 ...
 * decimal year.)
 */
export function neptuneOpp (y: number) { // (y float64)  (jde float64)
 ...
 */
export function el (y: number, a: Ca, t: readonly (readonly number[])[], e: readonly (readonly number[])[]): [number, number] { // (y float64, a *ca, t, e [][]float64)  (jde, elongation float64)
  const [J, M, T] = mean(y, a)
 ...
 * decimal year.)
 */
export function mercuryEastElongation (y: number) { // (y float64)  (jde, elongation float64)
 ...
 * decimal year.)
 */
export function mercuryWestElongation (y: number) { // (y float64)  (jde, elongation float64)
  return el(y, micA, mwt, mwe)
}

export function marsStation2 (y: number) { // (y float64)  (jde float64)
...
class Ca {
  ...
  constructor (A: number, B: number, M0: number, M1: number) {
