...
import { Coord } from './base.ts' // eslint-disable-line no-unused-vars
 ...
 */
export function smallest (c1: Coord, c2: Coord, c3: Coord) : [number, true | false] {
...
const noswap = function (a: number, b: number) : [number, number] {
  return [a, b]
}
