...
function snap (y: number, q: number) {
 ...
 * @returns {Number} jde
 */
export function meanNew (year: number) {
 ...
 * @returns {Number} jde
 */
export function meanFirst (year: number) {
 ...
 * @returns {Number} jde
 */
export function meanFull (year: number) {
 ...
 * @returns {Number} jde
 */
export function meanLast (year: number) {
 ...
 * @returns {Number} jde
 */
export function newMoon (year: number) {
 ...
 * @returns {Number} jde
 */
export function first (year: number) {
 ...
 * @returns {Number} jde
 */
export function full (year: number) {
 ...
 * @returns {Number} jde
 */
export function last (year: number) {
...
class Mp {
  ...
  nfc (c: readonly number[]): number {
    const { M, M_, E, F, Ω } = this
    return base.at(c, 0) * sin(M_) +
      base.at(c, 1) * sin(M) * E +
      base.at(c, 2) * sin(2 * M_) +
      base.at(c, 3) * sin(2 * F) +
      base.at(c, 4) * sin(M_ - M) * E +
      base.at(c, 5) * sin(M_ + M) * E +
      base.at(c, 6) * sin(2 * M) * E * E +
      base.at(c, 7) * sin(M_ - 2 * F) +
      base.at(c, 8) * sin(M_ + 2 * F) +
      base.at(c, 9) * sin(2 * M_ + M) * E +
      base.at(c, 10) * sin(3 * M_) +
      base.at(c, 11) * sin(M + 2 * F) * E +
      base.at(c, 12) * sin(M - 2 * F) * E +
      base.at(c, 13) * sin(2 * M_ - M) * E +
      base.at(c, 14) * sin(Ω) +
      base.at(c, 15) * sin(M_ + 2 * M) +
      base.at(c, 16) * sin(2 * (M_ - F)) +
      base.at(c, 17) * sin(3 * M) +
      base.at(c, 18) * sin(M_ + M - 2 * F) +
      base.at(c, 19) * sin(2 * (M_ + F)) +
      base.at(c, 20) * sin(M_ + M + 2 * F) +
      base.at(c, 21) * sin(M_ - M + 2 * F) +
      base.at(c, 22) * sin(M_ - M - 2 * F) +
      base.at(c, 23) * sin(3 * M_ + M) +
      base.at(c, 24) * sin(4 * M_)
  }
