...
import { Equatorial, Ecliptic } from './coord.ts'
import { Elements } from './elementequinox.ts'
import nutation from './nutation.ts'
import { HourAngle, Angle } from './sexagesimal.ts'
 ...
 */
export function approxAnnualPrecession (eqFrom: Equatorial, epochFrom: number, epochTo: number) {
 ...
 * @returns {Number[]}
 */
export function mn (epochFrom: number, epochTo: number) : [number, number, number] {
 ...
 */
export function approxPosition (eqFrom: Equatorial, epochFrom: number, epochTo: number, mα: number, mδ: number) {
 ...
 * @returns {Equatorial} [eqTo]
 */
export function position (eqFrom: Equatorial, epochFrom: number, epochTo: number, mα: number, mδ: number) {
 ...
 * @returns {Ecliptic} eclTo
 */
export function eclipticPosition (eclFrom: Ecliptic, epochFrom: number, epochTo: number, mα?: HourAngle, mδ?: Angle) {
 ...
 */
export function properMotion (mα: number, mδ: number, epoch: number, ecl: Ecliptic) {
 ...
 * @returns {Equatorial} eqTo
 */
export function properMotion3D (eqFrom: Equatorial, epochFrom: number, epochTo: number, r: number, mr: number, mα: HourAngle, mδ: Angle) {
