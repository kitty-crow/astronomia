 ...
 */
export function gt15True (h0: number) { // (h0 float64)  float64
  // (16.1) p. 105
 ...
 * of the body.  Unit is radians.
 */
export function gt15Apparent (h: number) { // (h float64)  float64
  // (16.2) p. 105
 ...
 * of the body.  Unit is radians.
 */
export function bennett (h0: number) { // (h0 float64)  float64
  // (16.3) p. 106
  const c1 = D2R / 60
 ...
 */
export function bennett2 (h0: number) { // (h0 float64)  float64
  const cMin = 60 / D2R
  const c06 = 0.06 / cMin
 ...
 */
export function saemundsson (h: number) { // (h float64)  float64
  // (16.4) p. 106
