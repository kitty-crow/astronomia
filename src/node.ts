 ...
 */
export function ellipticAscending (axis: number, ecc: number, argP: number, timeP: number) { // (axis, ecc, argP, timeP float64)  (jde, r float64)
 ...
 * Result is jde of the event and distance from the sun in AU.
 */
export function ellipticDescending (axis: number, ecc: number, argP: number, timeP: number) { // (axis, ecc, argP, timeP float64)  (jde, r float64)
  return el(Math.PI - argP, axis, ecc, timeP)
}

export function el (ν: number, axis: number, ecc: number, timeP: number) : [number, number] { // (ν, axis, ecc, timeP float64)  (jde, r float64)
 ...
 * Result is jde of the event and distance from the sun in AU.
 */
export function parabolicAscending (q: number, argP: number, timeP: number) { // (q, argP, timeP float64)  (jde, r float64)
 ...
 * Result is jde of the event and distance from the sun in AU.
 */
export function parabolicDescending (q: number, argP: number, timeP: number) { // (q, argP, timeP float64)  (jde, r float64)
  return pa(Math.PI - argP, q, timeP)
}

export function pa (ν: number, q: number, timeP: number) : [number, number] { // (ν, q, timeP float64)  (jde, r float64)
