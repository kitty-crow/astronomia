 ...
 * @param {Planet} mars
 */
export function physical (jde: number, earth: Planet, mars: Planet) : [number, number, number, number, number, number, number, number] { // (jde float64, earth, mars *pp.V87Planet)  (DE, DS, ω, P, Q, d, k, q float64)
  // Step 1.0
