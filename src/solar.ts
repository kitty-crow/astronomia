 ...
 *   {Number} ano - true anomaly in radians
 */
export function true2000 (T: number) {
 ...
 */
export function trueEquatorial (jde: number) {
 ...
 *   {Number} dec - declination in radians
 */
export function apparentEquatorial (jde: number) {
 ...
 */
export function trueVSOP87 (planet: Planet, jde: number) {
 ...
 *   {Number} range - range in AU
 */
export function apparentVSOP87 (planet: Planet, jde: number) {
 ...
 *   {Number} range - range in AU
 */
export function apparentEquatorialVSOP87 (planet: Planet, jde: number) {
 ...
 */
export function aberration (range: number) {
  // (25.10) p. 167
