 ...
 * Result in radians.
 */
export function phaseAngle (r: number, Δ: number, R: number) { // (r, Δ, R float64)  float64
 ...
 * the distance from Sun to Earth.  All distances in AU.
 */
export function fraction (r: number, Δ: number, R: number) { // (r, Δ, R float64)  float64
  // (41.2) p. 283
  const s = r + Δ
 ...
 */
export function phaseAngle2 (L: number, B: number, R: number, L0: number, R0: number, Δ: number) { // (L, B, R, L0, R0, Δ float64)  float64
  // (41.3) p. 283
 ...
 * The phase angle result is in radians.
 */
export function phaseAngle3 (L: number, B: number, x: number, y: number, z: number, Δ: number) { // (L, B, x, y, z, Δ float64)  float64
  // (41.4) p. 283
 ...
 */
export function fractionVenus (jde: number) { // (jde float64)  float64
 ...
 */
export function mercury (r: number, Δ: number, i: number) { // (r, Δ, i float64)  float64
  const s = toDeg(i) - 50
 ...
 * and i the phase angle in radians.
 */
export function venus (r: number, Δ: number, i: number) { // (r, Δ, i float64)  float64
  const iDeg = toDeg(i)
 ...
 * and i the phase angle in radians.
 */
export function mars (r: number, Δ: number, i: number) { // (r, Δ, i float64)  float64
 ...
 * Argument r is the planet's distance from the Sun, Δ the distance from Earth.
 */
export function jupiter (r: number, Δ: number) { // (r, Δ float64)  float64
 ...
 */
export function saturn (r: number, Δ: number, B: number, ΔU: number) { // (r, Δ, B, ΔU float64)  float64
 ...
 * Argument r is the planet's distance from the Sun, Δ the distance from Earth.
 */
export function uranus (r: number, Δ: number) { // (r, Δ float64)  float64
 ...
 * Argument r is the planet's distance from the Sun, Δ the distance from Earth.
 */
export function neptune (r: number, Δ: number) { // (r, Δ float64)  float64
 ...
 * and i the phase angle in radians.
 */
export function mercury84 (r: number, Δ: number, i: number) { // (r, Δ, i float64)  float64
 ...
 * and i the phase angle in radians.
 */
export function venus84 (r: number, Δ: number, i: number) { // (r, Δ, i float64)  float64
 ...
 * and i the phase angle in radians.
 */
export function mars84 (r: number, Δ: number, i: number) { // (r, Δ, i float64)  float64
 ...
 * and i the phase angle in radians.
 */
export function jupiter84 (r: number, Δ: number, i: number) { // (r, Δ, i float64)  float64
 ...
 * of the Sun and the Earth, measured in the plane of the ring.
 */
export function saturn84 (r: number, Δ: number, B: number, ΔU: number) { // (r, Δ, B, ΔU float64)  float64
  const s = Math.sin(Math.abs(B))
 ...
 * Argument r is the planet's distance from the Sun, Δ the distance from Earth.
 */
export function uranus84 (r: number, Δ: number) { // (r, Δ float64)  float64
 ...
 * Argument r is the planet's distance from the Sun, Δ the distance from Earth.
 */
export function neptune84 (r: number, Δ: number) { // (r, Δ float64)  float64
 ...
 * Argument r is the planet's distance from the Sun, Δ the distance from Earth.
 */
export function pluto84 (r: number, Δ: number) { // (r, Δ float64)  float64
