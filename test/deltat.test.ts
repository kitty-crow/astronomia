...
import { julian, deltat } from '../src/index.ts'
...
describe('#deltat', function () {
  const tests = [
    ...
    { date: [2018,  7,  1], exp:   69.1134027 },
    { date: [2019,  1,  1], exp:   69.2201929 },
    { date: [2019,  7,  1], exp:   69.3581644 },
    { date: [2020,  1,  1], exp:   69.3611547 },
    { date: [2020,  7,  1], exp:   69.4235824 },
    { date: [2021,  1,  1], exp:   69.3593373 },
    { date: [2021,  7,  1], exp:   69.3514219 }, // might change on new deltat data set
    { date: [2022,  1,  1], exp:   69.2944974 },
    { date: [2022,  7,  1], exp:   69.2553511 },
    { date: [2022, 12,  1], exp:   69.173303 },
    { date: [2024, 12, 31], exp:   68.597251 },
    { date: [2025,  1,  1], exp:   68.59818 },
